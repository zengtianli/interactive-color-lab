...
<!-- BEGIN:codex-project-claude-source -->
<!-- Generated by tools/harness/codex_projects.py; edit CLAUDE.md. -->
...
走站群：`/site add color` → nginx + CF DNS + Access app + website 卡片 → `~/Dev/wiki/topics/infra/ops-runbooks.md` § deploy（/deploy 已退役）。
<!-- END:codex-project-claude-source -->
