...
| 路径 | 内容 |
|---|---|
| `~/Dev/interactive-color-lab/` | 项目根，Next.js 16 + TS + Tailwind v4 |
| `~/Dev/interactive-color-lab/app/page.tsx` | 首页 · 两模块卡片 |
| `~/Dev/interactive-color-lab/app/free/page.tsx` | 模块一 · 73 path 曼陀罗 + 色轮 + PNG 导出 + localStorage 画廊（330 行） |
| `~/Dev/interactive-color-lab/app/pattern/page.tsx` | 模块二 · 3 槽位 + 羚羊纹样三层 + SVG `<pattern>` 4×4 平铺（360 行） |
| `~/Dev/interactive-color-lab/next.config.ts` | `output: 'export'` 启用静态导出 |
| `~/Dev/interactive-color-lab/CLAUDE.md` | 项目 CLAUDE.md（中文，含两模块速览） |
| `~/Dev/interactive-color-lab/README.md` / `README_CN.md` | 双语 README |
